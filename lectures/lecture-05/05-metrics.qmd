...
- In words: [When the model says "yes", how often is it right?](https://en.wikipedia.org/wiki/Precision_and_recall)
- High [precision](https://en.wikipedia.org/wiki/Precision_and_recall) = [few false alarms]{.alert}
...
:::{.column width=45%}
:::{style="text-align: center;"}
[![Precision focuses on predicted positives](figures/precision.gif){width="100%"}](#){data-modal-type="image" data-modal-url="figures/precision.gif"}

Source: [Medium](https://medium.com/data-science/precision-and-recall-made-simple-afb5e098970f)
:::
:::
:::
:::
...
- Also called [sensitivity](https://en.wikipedia.org/wiki/Precision_and_recall) or [true positive rate](https://en.wikipedia.org/wiki/Precision_and_recall)
- In words: [Of all actual positives, how many did we find?]{.alert}
- High [recall](https://en.wikipedia.org/wiki/Precision_and_recall) = [we don't miss many positives]{.alert}
...
:::{.column width=45%}
:::{style="text-align: center;"}
[![Recall focuses on actual positives](figures/recall.gif){width="100%"}](#){data-modal-type="image" data-modal-url="figures/recall.gif"}
...
:::{.column width=45%}
:::{style="text-align: center;"}
[![The precision-recall trade-off](figures/precision-recall-tradeoff.gif){width="100%"}](#){data-modal-type="image" data-modal-url="figures/precision-recall-tradeoff.gif"}
...
Source: [Medium](https://medium.com/@rahulchavan4894/understanding-train-test-and-validation-dataset-split-in-simple-quick-terms-5a8630fe58c8)
:::
:::
:::
:::
...
- [Stratified K-fold](https://en.wikipedia.org/wiki/Cross-validation_(statistics)): Preserves class proportions in each fold
:::

:::{.column width=45%}
:::{style="text-align: center;"}
[![10-fold cross-validation](figures/cv.gif){width="100%"}](#){data-modal-type="image" data-modal-url="figures/cv.gif"}

Source: [Calvin University](https://cs.calvin.edu/courses/data/202/ka37/slides/w11/w11d1-cv-review.html#1)
:::
:::
:::
:::
...
:::{.columns}
:::{.column width=55%}
- [Perplexity](https://en.wikipedia.org/wiki/Perplexity) measures how well a language model predicts a text
...
:::{.columns}
:::{.column width=55%}
- [ROUGE (Recall-Oriented Understudy for Gisting Evaluation)](https://en.wikipedia.org/wiki/ROUGE_(metric))
...
- Famous examples:
  - [MMLU](https://huggingface.co/spaces/TIGER-Lab/MMLU-Pro): 57 subjects of academic knowledge (maths, history, law...)
  - [HellaSwag](https://rowanzellers.com/hellaswag/): Commonsense reasoning
  - [TruthfulQA](https://github.com/sylinrl/TruthfulQA): Resistance to common misconceptions
  - [HumanEval](https://humaneval.org/): Code generation ability
  - [FrontierMath](https://epoch.ai/frontiermath): Mathematical problem-solving
...
:::{.column width=45%}
:::{style="text-align: center;"}
[![AI benchmarks](figures/ai-benchmarks.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/ai-benchmarks.png"}

Source: [Epoch AI](https://epoch.ai/gradient-updates/the-real-reason-ai-benchmarks-havent-reflected-economic-impacts)
:::
:::
:::
:::
...
### When metrics become targets ("benchmaxxing")
...
:::{style="text-align: center;"}
[![Goodhart's Law in action](figures/benchmaxxing.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/benchmaxxing.png"}
...
- [Precision/Recall trade-off]{.alert}: Choose based on the cost of false positives vs. false negatives
- Use [cross-validation]{.alert} and keep a truly unseen test set

**LLM & Modern AI Evaluation**:

- [BLEU/ROUGE measure overlap, not meaning or truth]{.alert}
- [Hallucinations]{.alert}: Confident lies are a fundamental limitation of current models
- Beware of [Goodhart's Law and "teaching to the test"]{.alert}
- [Subgroup Analysis]{.alert}: Always look beyond averages to identify bias and errors
:::
