...
:::{style="text-align: center;"}
[![Precision focuses on predicted positives](figures/precision.gif){width="60%"}](#){data-modal-type="image" data-modal-url="figures/precision.gif"}
:::
:::
...
- Important when **false negatives are costly**:
  - Disease screening, security threats
  - Don't miss sick patients!

[![Recall focuses on actual positives](figures/recall.gif){width="60%"}](#){data-modal-type="image" data-modal-url="figures/recall.gif"}
:::
:::
:::
...
:::{.columns}
:::{.column width=55%}
**[Benchmarks]{.alert}**: Standardised tests for AI

- Famous examples:
  - [MMLU](https://huggingface.co/spaces/TIGER-Lab/MMLU-Pro): 57 subjects of academic knowledge
  - [TruthfulQA](https://github.com/sylinrl/TruthfulQA): Resistance to misconceptions
  - [HumanEval](https://humaneval.org/): Code generation
- Enable [objective comparison]{.alert} across models

**[Leaderboards]{.alert}**: Human preference rankings

- [LM Arena](https://lmarena.ai/): Users compare anonymous model outputs
- Votes aggregated using [Elo ratings]{.alert} (like chess!)
- Captures [real preferences]{.alert}, not just benchmark scores
- Downside: Subjective, expensive, doesn't measure correctness
:::
...
- **Benchmark contamination**: Test data accidentally (or intentionally) appears in training data
