...
:::{.fragment}
That model [catches zero actual cases]{.alert}. Every sick patient is missed!
:::
:::
...
:::{.columns}
:::{.column width=55%}
- [RAG]{.alert}: the model [looks things up]{.alert} instead of relying on memory
- **How it works**:
...
:::{.columns}
:::{.column width=55%}
- [Red teaming]{.alert}: deliberately trying to make the AI fail, like hiring hackers to test your security
