...
This session prepares students for Quiz 01, which covers Lectures 01 to 07. Instead of a lecture, the class works through concepts out loud, applies them to a realistic scenario, and practises writing quiz-style answers.
...
- **Overfitting and validation**: why a model that fits the training data can still fail in use.
- **Tokens and embeddings**: how text becomes numbers a model can work with.
- **Multimodal systems**: images, audio, and text mapped into a shared embedding space.
