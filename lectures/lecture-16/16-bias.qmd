...
subtitle: "Lecture 16: Types of Bias and How They Arise"
author:
  - name: Danilo Freire
...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Lecture 16](https://danilofreire.github.io/datasci101/lectures/lecture-16/16-bias.html)"
    transition: slide
...
:::{.columns}
:::{.column width=50%}
- Last time we explored [AI agents]{.alert}: models that act, not just answer
- Tools, loops, compounding errors, and the [credit card test]{.alert}
- Before that: pipelines, monitoring, and [documentation]{.alert} (datasheets, model cards, system cards)
