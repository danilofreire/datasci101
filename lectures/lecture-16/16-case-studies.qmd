...
You may also include a bonus appendix with technical details, code, or extended analysis (not required)
:::

:::{.column width=45%}
**Key dates:**

- [March 23]{.alert} — group list due. If you don't have a group, you'll be assigned to one randomly
