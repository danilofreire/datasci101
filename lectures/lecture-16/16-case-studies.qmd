...
subtitle: "Lecture 16: AI in Finance and Healthcare"
author:
  - name: Danilo Freire
...
The common thread: give the model [structured input]{.alert}, get a classification or a number out.
:::
...
The LLM is the glue: it decides what to do next, calls the right tool, and passes results along. JPMorgan already uses AI agents for investment advice.
:::
