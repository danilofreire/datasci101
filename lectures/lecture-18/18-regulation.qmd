...
subtitle: "Lecture 18: AI Regulation and Standards Around the World"
author:
  - name: Danilo Freire
...
format:
  clean-revealjs:
    ...
    footer: "[Lecture 18](https://danilofreire.github.io/datasci101/lectures/lecture-18/18-regulation.html)"
    transition: slide
...
- Today: fairness is a [values question]{.alert}, so how are governments responding?
:::
...
:::{.column width=45%}
:::{style="text-align: center;"}
[![](figures/innovation-regulation.jpg){width="100%"}](#){data-modal-type="image" data-modal-url="figures/innovation-regulation.jpg"}
...
- July 2026: [Digital Omnibus]{.alert} delays high-risk rules to December 2027 (August 2028 for products)

**Scope:**

- [Extraterritorial reach]{.alert}: any AI sold in the EU, wherever it was built
...
- Training data: [relevant, representative, as error-free as possible]{.alert}
...
:::{.columns}
:::{.column width=55%}
- Release weights under a free licence and you skip the [documentation duties]{.alert}
- You must still respect copyright and publish a training summary
- Models of [systemic risk]{.alert} (over 10^25^ FLOPs) still face the stricter tier
- Open models allow [independent scrutiny]{.alert}, a partial substitute for regulatory oversight
- Supports European open-source research

**Criticism:**

- A potential [loophole]{.alert}: open models can still cause harm once third parties deploy them
...
**Example:** [Mistral](https://mistral.ai/) is a French AI company that releases many open models. [Epoch AI](https://epoch.ai/data-insights/models-over-1e25-flop) estimates its largest (like Mistral Large) passed the systemic-risk threshold, so they face the stricter rules. Its smaller open models would be largely exempt.
:::
:::
:::
:::
...
:::
:::{.fragment}
   - [Depends]{.alert}: scanning crowds is high risk; a 1:1 passport check is not
:::
:::
...
- First comprehensive state AI law, with [impact assessments]{.alert}
- [Replaced in May 2026](https://leg.colorado.gov/bills/sb26-189) by a narrower law: notices, explanations, human review (from 2027)

**California:**

- [SB 53 (2025)](https://leginfo.legislature.ca.gov/faces/billNavClient.xhtml?bill_id=202520260SB53): frontier AI developers must publish safety plans and report incidents
...
:::{.column width=40%}
:::{style="text-align: center;"}
[![](figures/state-ai-laws.png){width="70%"}](#){data-modal-type="image" data-modal-url="figures/state-ai-laws.png"}
...
- No AI law since; Canada named its first AI minister in May 2025
...
:::{style="margin-top: 20px;"}
The EU passed the first [comprehensive, binding law]{.alert}; South Korea's and Vietnam's took effect in 2026. If your company sells AI in both the EU and the US, you will need two separate compliance strategies.
:::
:::
:::
:::

# What this means for practitioners {background-color="#1B3A6B"}
