...
- Careful estimates find [no effect on earnings or hours]{.alert} so far
- Young workers in AI-exposed jobs are [19% below]{.alert} their peers
...
- The business model: [sell your attention to advertisers]{.alert}, as TV and newspapers did
...
- [*The Attention Merchants*](https://www.goodreads.com/book/show/28503628-the-attention-merchants) (Wu, 2016): the same logic from 19th-century papers to social media
:::
...
- TikTok read test bots' interests in [under 2 hours]{.alert}, from how long they lingered ([WSJ, 2021](https://www.wsj.com/articles/tiktok-algorithm-video-investigation-11626877477))
...
- [Guess et al. (2023, *Science*)](https://www.science.org/doi/10.1126/science.abp9364): a chronological feed made [little difference]{.alert} to attitudes
- Polarisation is [one outcome]{.alert}. Effects on anxiety, body image and sleep are [still debated]{.alert}
:::
...
:::{style="background: rgba(45, 69, 99, 0.1); padding: 15px; border-radius: 10px; font-size: 20px; margin-top: 15px;"}
Good news on political polarisation. Mental health is [a separate, contested question]{.alert}. Don't confuse the two
:::
:::
:::
:::
...
- "Outrage drives clicks" ([Brady et al., 2017, *PNAS*](https://www.pnas.org/doi/10.1073/pnas.1618923114)): each moral-emotional word raised retweets [~20%]{.alert}
...
:::{style="background: rgba(230, 57, 70, 0.1); padding: 15px; border-radius: 10px; font-size: 20px; margin-top: 15px;"}
Companies answer to shareholders, not users. When engagement and wellbeing conflict, [engagement wins]{.alert}
:::
:::
:::
:::
...
- Haidt's evidence is mostly correlational: teen depression rose [as smartphones spread]{.alert}
...
- Most associations are [small]{.alert} ([1](https://academic.oup.com/jcmc/article/29/1/zmad055/7595758?login=false&guestAccessKey=)); heavy or problematic use shows stronger links ([2](https://jamanetwork.com/journals/jamanetworkopen/fullarticle/2834349), [3](https://mental.jmir.org/2022/4/e33450/))
...
- [US Surgeon General](https://pubmed.ncbi.nlm.nih.gov/37721985/): [youth mental health advisory]{.alert} (2023), then a [call for warning labels](https://www.cnn.com/2024/06/17/media/surgeon-general-social-media-apps-warning-label/) (2024)
:::
...
- The [Algorithmic Recommendation Provisions](https://www.chinalawtranslate.com/en/algorithms/) make every app offer a non-personalised feed
- Douyin, Baidu, Taobao and WeChat added [one-tap opt-out]{.alert} buttons
- Chinese users [dislike the algorithm but rarely quit it](https://journals.sagepub.com/doi/10.1177/20594364231209354); effects of opting out are still being studied
- The [EU Digital Services Act](https://dsa-observatory.eu/2024/11/22/the-regulation-of-recommender-systems-under-the-dsa-a-transition-from-default-to-multiple-and-dynamic-controls/) (Article 38) now makes very large platforms offer a non-profiling feed
- China mandates algorithmic transparency and keeps [state censorship]{.alert}. Both are true
:::
...
:::{.columns}
:::{.column width=55%}
- WHO: [75%]{.alert} of people with mental illness in low- and middle-income countries get *no treatment*
- Even in wealthy countries:
  - US wait for a first psychiatric visit: [median 67 days](https://pubmed.ncbi.nlm.nih.gov/37290263/) (five states), longer if rural
...
:::{.column width=45%}
:::{style="text-align: center;"}
[![Suicide-prevention programmes by country income (WHO)](figures/mental-health-gap.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/mental-health-gap.png"}
...
:::{.columns}
:::{.column width=55%}
- [**Woebot**](https://mental.jmir.org/2017/2/e19) (2017-2025): scripted CBT chatbot, ~1.5M users; [closed in 2025](https://www.statnews.com/2025/07/02/woebot-therapy-chatbot-shuts-down-founder-says-ai-moving-faster-than-regulators/)
- [**Wysa**](https://www.wysa.com/nhs-talking-therapies): same model, used in [31 NHS talking-therapy services](https://blogs.wysa.io/blog/company-news/nhs-tackles-mental-health-crisis-with-ai)
- [**Replika**](https://replika.com/): not therapy, an "AI companion". People form [real emotional attachments]{.alert} (risks shortly)
- [Habicht et al. (2025, *JMIR*)](https://www.jmir.org/2025/1/e60435), an observational NHS study: generative AI alongside group therapy
...
- **Harmful responses.** LLMs showed [stigma]{.alert} and mishandled crises ([Moore et al., 2025](https://arxiv.org/abs/2504.18412))
- **No crisis escalation.** A chatbot cannot call an ambulance
- **Regulatory gap.** Most are apps, not medical devices; a few states ([Illinois](https://idfpr.illinois.gov/news/2025/gov-pritzker-signs-state-leg-prohibiting-ai-therapy-in-il.html)) ban AI therapy
:::
...
- Weigh harmful responses against [no care at all]{.alert}, the norm in poorer countries
...
- Hold [reliable long-term memory]{.alert}: chatbot memory is not clinical continuity
...
- [OpenAI added crisis signposting](https://openai.com/index/strengthening-chatgpt-responses-in-sensitive-conversations/) to ChatGPT in 2025: people [already use it this way]{.alert}
...
- [Google (2026)](https://sustainability.google/google-2026-environmental-report/): emissions up [81% since 2019]{.alert}, driven by AI data centres
:::
...
:::{.columns}
:::{.column width=55%}
- [Li et al. (2023)](https://arxiv.org/abs/2304.03271): training GPT-3 used ~[700,000 litres]{.alert} of cooling water
- GPT-3: ~500ml per 10-50 responses; Google reports [0.26ml per Gemini prompt](https://arxiv.org/abs/2508.15734)
- A [political flashpoint]{.alert}: 70% of Americans would oppose a local data centre ([Gallup, 2026](https://news.gallup.com/poll/709772/americans-oppose-data-centers-area.aspx))
- Overall, [probably overstated]{.alert}: [627m gallons a day](https://www.axios.com/2026/06/25/water-energy-ai-flashpoint), less than US golf courses
- About [75%]{.alert} of a data centre's water footprint comes from generating its electricity, not on-site cooling
- The real problem is [local]{.alert}: clusters in Phoenix, Las Vegas and Santiago, Chile are water-stressed
:::
...
- The worry is the [growth rate]{.alert}: AI servers' electricity may grow ~30% a year (all data centres: ~12%)
...
- Energy per Gemini prompt fell 33x in a year, but the queries [multiplied]{.alert}
:::

:::{.column width=45%}
:::{style="text-align: center; margin-top: 30px;"}
[![Adding between one Sweden and one Germany by 2026](figures/ai-footprint-context.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/ai-footprint-context.png"}
...
- **Grid optimisation**: predicts wind output 36 hours ahead, raising its value ~20% ([DeepMind, 2019](https://deepmind.google/discover/blog/machine-learning-can-boost-the-value-of-wind-energy/))
...
- **Data centre cooling**: [DeepMind's system](https://deepmind.google/discover/blog/deepmind-ai-reduces-google-data-centre-cooling-bill-by-40/) cut cooling energy by [up to 40%]{.alert}
- [Rolnick et al. (2022)](https://dl.acm.org/doi/10.1145/3485128): dozens of ML applications, from agriculture to carbon capture
...
- [Attention economy]{.alert}: systems optimise engagement, not wellbeing. Filter bubble fears look overstated; mental health effects are debated
