...
This lecture looks at the history of AI, from early thoughts and the Turing Test to modern Large Language Models. We explore how the field moved from manual rules to systems that learn from data. Finally, we discuss how transformers and ChatGPT change how we use AI today.

## Main Ideas

### 1. From Myths to Machines
...
* **Symbolic AI**: Using logic and codes to mimic intelligence (like ELIZA).
* **Expert Systems**: Using human rules to solve specific problems.
* **AI Winters**: Times when progress slowed down and funding was cut.
