...
- We will use Canvas for announcements and grades
...
- Multi-layer networks *could* solve these problems, but [training them was hard]{.alert}
...
- This is the "[scaling hypothesis]{.alert}"
:::
...
- Three key innovations:
  ...
  3. [Safety training](https://en.wikipedia.org/wiki/AI_safety)x: Reduce harmful outputs
...
- Dick, S. (2019). [Artificial intelligence.](https://doi.org/10.1162/99608f92.92fe150c) *Harvard Data Science Review*, *1*(1). A brief history of AI research and applications.

- Grzybowski, A., et al. (2024). [A history of artificial intelligence.](https://doi.org/10.1016/j.clindermatol.2023.12.016) *Clinics in Dermatology*, *42*(3), 221-229. A "pre-history" overview.

- Cao, Y., et al. (2023). [A comprehensive survey of AI-generated content (AIGC).](https://arxiv.org/abs/2303.04226) *arXiv preprint*. Overview of generative AI methods.

- Halevy, A., Norvig, P., & Pereira, F. (2009). [The unreasonable effectiveness of data.](https://static.googleusercontent.com/media/research.google.com/en//pubs/archive/35179.pdf) *IEEE Intelligent Systems*, *24*(2), 8-12.

- Pradhan, M. (2023). [A non-technical introduction to Transformers.](https://medium.com/healthcare-ai-sig/a-non-technical-introduction-to-transformers-6ca36b8246d)

- Georgia Tech. (2025). [Transformer explainer.](https://poloclub.github.io/transformer-explainer/) Interactive visualisation.
:::
