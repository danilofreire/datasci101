...
# Transformers: the architecture that changed everything ⚡ {background-color="#1B3A6B"}
...
- Like a [search engine]{.alert} where each word searches for relevant context
:::
...
:::{.columns}
:::{.column width=55%}
- After attention, each token passes through a [feed-forward network]{.alert} (FFN, Multi-Layer Perceptron, MLP)
