...
:::{style="margin-top: 15px; background: rgba(230, 57, 70, 0.1); padding: 15px; border-radius: 10px;"}
[Bottom line]{.alert}: Before you worry about hallucinations, ask yourself whether you actually need the AI to be factual right now.
:::
:::
:::
:::
...
Let's ask <https://chat.z.ai/> these questions and request a [confidence rating (1-10)]{.alert} for each answer. [Z.ai](https://chat.z.ai/) was chosen because you can turn off web access
...
[Golden rule]{.alert}: If the AI gives you a precise percentage or a page number, that's exactly when you should double-check.
:::
:::
:::
:::
...
[No!]{.alert} But it can reduce them. Combining several of these techniques in one prompt works better than any single trick.
:::
:::
...
:::{style="margin-top: 15px; font-size: 18px;"}
**Next slides**: We'll build [more sophisticated templates]{.alert} using PTCF and meta-prompting from Lecture 10!
:::
:::
:::
:::
...
:::{.columns}
:::{.column width=55%}
Remember the [**PTCF framework**](https://danilofreire.github.io/datasci101/lectures/lecture-10/10-prompting.html) from last class?
...
:::{style="margin-top: 15px; background: rgba(230, 57, 70, 0.1); padding: 15px; border-radius: 10px;"}
[Key insight]{.alert}: You're basically asking the model "how should I talk to you so you don't make things up?"
:::
:::
...
:::{style="margin-top: 15px; font-size: 18px;"}
**Try it!** Ask ChatGPT or Claude to critique and improve your prompts. The suggestions are often [better than what you'd write on your own]{.alert}.
:::
:::
:::
:::
...
- Can [cite sources]{.alert}, so you can verify!
