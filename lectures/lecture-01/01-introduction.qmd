...
`r fa('globe')` [Course website:]{.alert} <https://danilofreire.github.io/datasci101>

`r fa('github')` Course repository: <https://github.com/danilofreire/datasci101>

The website is [the main hub for your learning]{.alert}, while the assignments and group work files will be available on the repository
...
:::{.columns}
:::{.column width=60%}
- Learning a new topic can be tough and push you out of your comfort zone. If the course pace is too fast, let me know. I expect your commitment, but [I do not want anyone to fail]{.alert}
...
- [Design]{.alert} a small, realistic plan for an AI application, including data needs, evaluation, and a basic harm-mitigation strategy 
...
- Why is this course different from others?
  ...
  - [Real-world focus:]{.alert} Learn how AI is applied in practice
  - [For all backgrounds:]{.alert} Whether you're a humanities or STEM student, this course is for you!
:::
...
- [Syllabus:]{.alert} Available on our [course repository](https://github.com/danilofreire/datasci101/blob/main/syllabus.pdf) and [website](https://danilofreire.github.io/datasci101/syllabus.html). The course is designed to be self-contained
- The syllabus and the website includes links to the slides we will use in class, along with recommended readings, and problem sets
- I may update the slides as the course progresses, so please check the website regularly for updates
