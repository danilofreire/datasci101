...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Lecture 01](https://raw.githack.com/danilofreire/datasci101/main/lectures/lecture-01/01-introduction.html)"
    transition: slide
...
# Welcome to DATASCI 101! 🎉 {background-color="#2d4563"}
...
- This is the first offering of DATASCI 101 — help us make it great! 🙌
