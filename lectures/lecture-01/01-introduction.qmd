...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Lecture 01](https://raw.githack.com/danilofreire/datasci185/main/lectures/lecture-01/01-introduction.html)"
    transition: slide
...
# Welcome to DATASCI 185! 🎉 {background-color="#2d4563"}
...
![](figures/cute-robot.png){width="70%"}
:::
:::
:::
:::
...
`r fa('github')` Course repository: <https://github.com/danilofreire/datasci185>

`r fa('globe')` Course website: <https://danilofreire.github.io/datasci185>

All course materials, including lectures, code, assignments, and project guidelines, are available on our [GitHub repository](https://github.com/danilofreire/datasci185) and [course website](https://danilofreire.github.io/datasci185)
...
- Tell us your name, your major, what AI application you find most interesting, and what would you like to learn in this course? 
:::
...
- [Syllabus:]{.alert} Available on our [course repository](https://github.com/danilofreire/datasci185/blob/main/syllabus.pdf) and [website](https://danilofreire.github.io/datasci185/syllabus.html). The course is designed to be self-contained. The syllabus includes links to the slides we will use in class, along with recommended readings, and problem sets. I will upload slides throughout the term as we progress
- [Schedule:]{.alert} Lectures are on Mondays and Wednesdays from 4:00 to 4:50 pm
...
# Motivation: <br> What the heck is AI anyway? 🤖 {background-color="#2d4563"}
...
- If the predictions are correct, [AI will be one of, if not the most, important technological advancements of our time]{.alert}
:::
...
- [Main takeaway:]{.alert} Understanding how AI evolved helps us understand where it's going
- [Preparation:]{.alert} Read the assigned articles on AI history and transformers
:::

:::{.column width=50%}
:::{style="text-align: center; margin-top: -30px;"}
[![](figures/thinking-game.jpg){width="60%"}](https://www.youtube.com/watch?v=d95J8yzvjbQ)

Suggested video: [The Thinking Game](https://www.youtube.com/watch?v=d95J8yzvjbQ)
:::
:::
:::
:::
