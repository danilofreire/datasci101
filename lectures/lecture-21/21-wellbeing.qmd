...
- You have limited hours and limited focus. That's the scarce resource ([Becker, 1965 - "A theory of the allocation of time"](https://academic.oup.com/ej/article-abstract/75/299/493/5250146))
...
- Compelling narrative. But what do the numbers say?
- [Orben & Przybylski (2019, *Nature Human Behaviour*)](https://www.nature.com/articles/s41562-018-0506-1): screen time explains [at most 0.4%]{.alert} of the variance in adolescent wellbeing
- For context, wearing glasses has a [3x larger]{.alert} negative association. Eating potatoes has a similar one. Sleep is [44x]{.alert} more strongly associated
- Haidt's evidence is mostly correlational: teen depression rose *around the same time* as smartphone adoption. But correlation is not causation (remember lecture 03?)
...
- Neither side is wrong, exactly. Haidt asks the right question; Orben and Odgers insist on [the right standard of evidence]{.alert}
:::
...
When someone says "screens are destroying a generation," ask: [how large is the effect, and what else was measured?]{.alert}
:::
:::
:::
:::
...
- No Western democracy has tried anything this direct
...
- The uncomfortable question: China moved first on algorithmic transparency. [Does it matter who passes a good law?]{.alert}
:::
...
⏱️ 3 minutes. I'll ask a few of you.
:::
:::
...
- **Replika**: not therapy, but an "AI companion." People form real emotional attachments
  - In 2023, the company [changed its relationship features](https://www.vice.com/en/article/ai-companion-replika-erotic-roleplay-updates/) after an Italian regulatory order
...
- Hold [persistent memory]{.alert} between sessions. Every conversation starts fresh, the opposite of how therapy works (we can solve this with RAG, but it's not the default)
