...
- Traditional surveillance was limited; AI-enabled collection is [cheap, pervasive, and continuous]{.alert}
...
:::{.columns}
:::{.column width=55%}
[Synthetic data]{.alert} is artificially generated data that preserves the statistical properties of real data without containing actual personal information.
...
- [Context and governance determine outcomes]{.alert}
:::
...
:::{style="font-size: 18px; margin-top: 15px;"}
"The technology is neutral" is a dodge. Technology [embeds values]{.alert} in its design and deployment. The question is whose values.
:::
:::
:::
:::
...
:::{style="background: rgba(45, 69, 99, 0.1); padding: 15px; border-radius: 10px; font-size: 18px; margin-top: 15px;"}
Individual action is necessary but not sufficient. [Systemic problems require systemic solutions]{.alert}. That means policy, not just personal choices.
:::
:::
:::
:::
...
"Privacy is not about having something to hide. It's about having the [power to choose]{.alert} what to reveal."
:::
:::
:::
:::
