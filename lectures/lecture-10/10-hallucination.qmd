...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Lecture 10](https://raw.githack.com/danilofreire/datasci101/main/lectures/lecture-10/10-hallucination.html)"
    transition: slide
...
:::{.columns}
:::{.column width=55%}
Remember the [**PTCF framework**](https://raw.githack.com/danilofreire/datasci101/main/lectures/lecture-09/09-prompting.html) from last class?
