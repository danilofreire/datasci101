...
- Mis-, dis- and malinformation differ by intent
...
- Side effects: polarisation, addiction, both outside the objective function
...
- Surveys the alignment problem and the techniques used on it
...
- AI should value human control, not because it was told to
- Because control is [instrumentally useful]{.alert} for its actual goals
:::
...
:::{style="background: rgba(45, 69, 99, 0.1); padding: 15px; border-radius: 10px; font-size: 18px; margin-top: 15px;"}
Russell wrote the most-used [AI textbook]{.alert} (*AI: A Modern Approach*). When he says we have a problem, it is worth listening
:::
:::
:::
:::
