...
:::{style="background: rgba(45, 69, 99, 0.1); padding: 15px; border-radius: 10px; font-size: 18px; margin-top: 15px;"}
You don't need to predict the future. You need to [think clearly about what AI can and cannot do]{.alert} in a specific role.
:::
:::
:::
:::
...
The job market that existed when you started university [may not be the same when you graduate]{.alert}. That is unsettling, and there is no point pretending otherwise.

But the people who learn to [work with AI]{.alert} will have an edge over those who ignore it.
:::
