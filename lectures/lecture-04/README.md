...
* **The Workflow**: How to split data into training and test sets to simulate real-world use.
...
* **Cross-validation**: A robust way to evaluate a model by testing it on different parts of the data.

### 3. Unsupervised Learning

* **Finding Structure**: Grouping similar data points (clustering) or simplifying complex information.
* **Anomaly Detection**: Learning what "normal" looks like to flag unusual events like fraud.
