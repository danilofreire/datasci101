...
- [Super cool example]{.alert} (we will see it in [lecture 06!](https://danilofreire.github.io/datasci101/lectures/lecture-06/06-language.html)): <https://projector.tensorflow.org/>
:::
...
:::{.columns}
:::{.column width=55%}
- [Alignment problem]{.alert}: Ensuring models do what we *mean*, not what we literally *say*
...
- [Safety needs to be part of training]{.alert}, not something you bolt on later
:::
...
- `r fa('balance-scale')` The [bias-variance trade-off]{.alert}: Simple models underfit, complex models overfit
