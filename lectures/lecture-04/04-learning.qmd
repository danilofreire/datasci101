...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Lecture 04](https://raw.githack.com/danilofreire/datasci101/main/lectures/lecture-04/04-learning.html)"
    transition: slide
...
- [Super cool example]{.alert} (we will see it in [lecture 06!](https://raw.githack.com/danilofreire/datasci101/main/lectures/lecture-06/06-language.html)): <https://projector.tensorflow.org/>
:::
