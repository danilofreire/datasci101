...
<!-- Suggested image: collage of different AI interfaces - ChatGPT, Claude, Gemini, Midjourney -->
...
:::{style="text-align: center; margin-top: 30px;"}
[![](figures/meme-of-the-day.png){width="55%"}](#){data-modal-type="image" data-modal-url="figures/meme-of-the-day.png"}
...
[![](figures/chevy.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/ai-failures-02.webp"}
...
:::{.column width=45%}
:::{style="text-align: center; margin-top: 30px;"}
[![Monitoring dashboard](figures/monitoring-dashboard.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/monitoring-dashboard.png"}
...
:::{.column width=45%}
:::{style="text-align: center;"}
[![](figures/temperature.gif){width="90%"}](#){data-modal-type="image" data-modal-url="figures/temperature.gif"}
