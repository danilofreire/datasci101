...
| Gemini Pro / Claude / GPT-5 | 1,000,000+ tokens |
:::
...
- [Non-English languages use more tokens]{.alert}
  - Chinese, Japanese, Korean: ~2-3x more tokens per concept. Higher costs and shorter effective context
:::
...
- The colours show numbers from -2 to +2, but the actual embeddings are 4,096-dimensional!
...
| DeepSeek-V4-Pro (2026) | 1.6 trillion | 49 billion | 33 trillion tokens |
