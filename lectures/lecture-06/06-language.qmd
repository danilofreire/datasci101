...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Lecture 06](https://raw.githack.com/danilofreire/datasci185/main/lectures/lecture-06/06-language.html)"
    transition: slide
...
- **Traditional ML metrics**: Accuracy, precision, recall, ROC/AUC
...
<!-- Suggested image: A meme about model evaluation or accuracy paradox -->
<!-- Source: Search for "machine learning accuracy meme" or use figures/accuracy-meme.png -->
...
<!-- Suggested image: LLM processing pipeline diagram or word embeddings visualisation -->
...
## Tweet of the day (sorry for the curse word! 😅)
### Every AI engineer's journey starts somewhere... 

:::{style="text-align: center; margin-top: 30px;"}
<!-- Suggested image: A funny tweet about tokens, embeddings, or LLMs -->
<!-- Search Twitter/X for funny AI/NLP tweets -->
[![](figures/tweet-of-the-day.png){width="45%"}](#){data-modal-type="image" data-modal-url="figures/tweet-of-the-day.png"}
:::

# How LLMs "See" Text 👁️ {background-color="#2d4563"}
...
:::{.columns}
:::{.column width=55%}
- Here's something you may not know: [Computers only understand numbers]{.alert}
...
[Every word you type goes through this transformation!]{.alert}
:::
...
:::{.column width=45%}
:::{style="text-align: center;"}
<!-- Suggested image: Context window visualisation -->
...
### When tokenisation gets weird

:::{style="margin-top: 30px; font-size: 21px;"}
:::{.columns}
:::{.column width=55%}
**Tokenisation quirks to know about:**

- [Emojis]{.alert} are encoded as multiple tokens
  - "🎉" → 2+ tokens (it's bytes, not characters!)
  - "👨‍👩‍👧‍👦" (family) → 7+ tokens!
- [Non-English languages]{.alert} use more tokens
  - Chinese, Japanese, Korean: ~2-3x more tokens per concept
  - This means higher costs and shorter effective context
- [Code]{.alert} tokenises differently than prose
  - Indentation and special characters add up
- [Numbers]{.alert} are split in unexpected ways
  - "1000000" might be multiple tokens

[The model's "native language" is its training data distribution!]{.alert}
:::
...
<!-- Suggested image: Multilingual tokenisation comparison -->
...
# Embeddings 🌌 {background-color="#2d4563"}
...
### Capturing meaning, not just characters
...
- "cat" and "kitten" would be completely unrelated
- The model couldn't know synonyms or relationships
- Context would be impossible to understand

**With embeddings:**

- Words with [similar meanings]{.alert} are nearby in the space
- Words with [similar grammatical roles]{.alert} cluster together
- [Context changes meaning]{.alert}: "bank" (river) vs "bank" (money)
- Relationships are preserved:
  - Verbs cluster with verbs
  - Nouns cluster with nouns
  - Animals form a region, vehicles form another
:::
...
- 📝 [Semantic]{.alert}: Meaning and concepts
- 📖 [Syntactic]{.alert}: Grammar and structure
- 🔗 [Relational]{.alert}: How words connect
- 🌍 [Contextual]{.alert}: Different senses
:::

<!-- Suggested image: Word clustering visualisation -->
[![Inaugural Address word clusters](figures/word-clusters.gif){width="100%"}](#){data-modal-type="image" data-modal-url="figures/word-clusters.gif"}

Source: [Wikipedia](https://commons.wikimedia.org/wiki/File:Inaugural_Address_word_clouds.gif)
:::
:::
:::
:::
...
<!-- Suggested image: King-queen vector arithmetic diagram -->
...
- [Word2Vec](https://en.wikipedia.org/wiki/Word2vec) (2013): One vector per word, [fixed]{.alert}
  - "bank" always has the same embedding
- [ELMo](https://en.wikipedia.org/wiki/ELMo) (2018): [Context-dependent]{.alert} word embeddings
  - "river bank" vs "bank account" → different vectors!
- [BERT](https://en.wikipedia.org/wiki/BERT_(language_model)) (2019): Deep [contextual]{.alert} embeddings
  - Considers the whole sentence
- [GPT/Transformer](https://en.wikipedia.org/wiki/Generative_pre-trained_transformer) embeddings: Even richer context
  - Every layer adds more understanding

**Modern sentence embeddings:**

- Entire sentences → single vector
- Used for search, similarity, clustering
- Models: text-embedding-ada-002, Sentence-BERT
:::

:::{.column width=45%}
:::{style="text-align: center;"}
<!-- Suggested image: Evolution of embeddings timeline -->
[![](figures/embedding-evolution.webp){width="100%"}](#){data-modal-type="image" data-modal-url="figures/embedding-evolution.webp"}

Source: [Geeks for Geeks](https://www.geeksforgeeks.org/nlp/word-embeddings-in-nlp/)
:::
:::
:::
:::
...
# Parameters: The LLM's Brain 🧠 {background-color="#2d4563"}
...
[TL;DR: Weights and biases together determine how the model processes information]{.alert}
:::
...
# Putting It All Together 🔗 {background-color="#2d4563"}
...
- [The Ultimate Guide to Word Embeddings](https://neptune.ai/blog/word-embeddings-guide) - Neptune.ai
- [Tokenization in NLP](https://neptune.ai/blog/tokenization-in-nlp) - Neptune.ai
- [An Intuitive Introduction to Text Embeddings](https://stackoverflow.blog/2023/11/09/an-intuitive-introduction-to-text-embeddings/) - StackOverflow

**Recommended:**

- [What Even Is a Parameter?](https://www.technologyreview.com/2026/01/07/1130795/what-even-is-a-parameter/) - MIT Tech Review
- [Beginner's Guide to Embeddings](https://www.prompthub.us/blog/a-beginners-guide-on-embeddings-and-their-impact-on-prompts) - PromptHub
:::

:::{.column width=50%}
**Interactive tools:**

- [OpenAI Tokenizer](https://platform.openai.com/tokenizer) - See tokenisation in action
- [TensorFlow Projector](https://projector.tensorflow.org/) - Explore embedding space

**Videos:**

- [Word2Vec Explained](https://www.youtube.com/watch?v=viZrOnJclY0) (10 min)
- [The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) - Jay Alammar
- [3Blue1Brown Neural Networks](https://www.youtube.com/playlist?list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi) (Series)
:::
:::
:::
