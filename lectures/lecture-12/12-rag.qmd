...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Lecture 12](https://raw.githack.com/danilofreire/datasci101/main/lectures/lecture-12/12-rag.html)"
    transition: slide
...
[The preparation work pays off because you only do it once; after that, every query is fast]{.alert} 📚
:::
:::
...
3. Ask: "What are the assignment deadlines for DATASCI 101 at Emory University?"
...
In each case, the user needs answers grounded in [specific documents]{.alert}, and the system needs to cite where the answer came from
