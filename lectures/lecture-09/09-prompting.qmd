...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Lecture 09](https://raw.githack.com/danilofreire/datasci101/main/lectures/lecture-09/09-prompting.html)"
    transition: slide
...
:::{.columns}
:::{.column width=55%}
Remember from [Lecture 06](https://raw.githack.com/danilofreire/datasci101/main/lectures/lecture-06/06-language.html): LLMs predict the [next token]{.alert} based on probability distributions learned during training.
...
:::{.columns}
:::{.column width=55%}
Also from [Lecture 06](https://raw.githack.com/danilofreire/datasci101/main/lectures/lecture-06/06-language.html): **hyperparameters** are settings [you control]{.alert} that affect model behaviour:
