...
Asking models to show their reasoning [dramatically improves accuracy]{.alert} on complex tasks!
...
Build a mental [reliability map]{.alert}: learn where your model works well and where it stumbles. [This knowledge comes from experience]{.alert}
