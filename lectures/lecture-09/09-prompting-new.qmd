...
subtitle: "Lecture 09: Prompting Techniques"
author:
  - name: Danilo Freire
...
:::{.columns}
:::{.column width=55%}
Remember from [Lecture 06](https://raw.githack.com/danilofreire/datasci185/main/lectures/lecture-06/06-language.html): LLMs predict the [next token]{.alert} based on probability distributions learned during training.
...
- It draws on patterns from [trillions of tokens]{.alert} of training data
...
[Prompt engineering is about activating the right patterns]{.alert}.
:::
...
:::{.columns}
:::{.column width=55%}
Also from [Lecture 06](https://raw.githack.com/danilofreire/datasci185/main/lectures/lecture-06/06-language.html): **hyperparameters** are settings [you control]{.alert} that affect model behaviour:
...
**What's wrong with it? (Use PTCF to diagnose)**
...
⏱️ 2-3 minutes, then share with your neighbour!
:::
:::
...
## Activity: The classic reasoning trap 🪤
...
**Why it's wrong**: If ball = $0.10, then bat = $1.10, and total = $1.20 ≠ $1.10

**Correct answer**: Ball = $0.05, Bat = $1.05, Total = $1.10 ✓
:::
:::
...
:::{.column width=45%}
:::{style="text-align: center;"}
[![](figures/kimi-reasoning.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/o1-reasoning.png"}
...
# Common mistakes and debugging 🔧 {background-color="#2d4563"}
...
Build a mental [reliability map]{.alert}—learn where your model works well and where it stumbles. This knowledge comes from experience, not documentation.
...
- `r fa('flask')` **Prompt engineering is empirical**: Test, measure, iterate. What works for one task may fail for another.
...
5. [Verify critical outputs]{.alert}—models fail unexpectedly
