...
3. **Finance**: credit scoring, fraud detection, robo-advisors
4. **Law**: contract review, legal research assistants, case-outcome prediction
5. **Creative industries**: AI-generated art, music, or writing; content moderation systems
6. **Scientific research**: literature search and summarisation, protein-structure prediction, experiment design
7. **Customer service**: support chatbots, ticket routing and triage, sentiment analysis of feedback
...
| Date | What happens |
|------|-------------|
| **October 27** (Lecture 17) | Project instructions released |
| **November 3** | Deadline to form your group |
| **November 5** | Students without a group are assigned randomly |
| **November 12** | Optional proposal due on Canvas |
| **November 12-19** | Feedback on proposals |
| **December 8** | Final report and infographic due at 11:59 PM on Canvas |

# Group formation

You have until **November 3** to form a group of 4-5 students. If you have not joined a group by then, I will assign you to one randomly on November 5. If your group was formed by random assignment, I particularly encourage you to submit the optional proposal so you can get early feedback and start coordinating.

# Deliverables

## Project proposal (optional, strongly recommended)

**Due: November 12 on Canvas. Not graded.**
...
**Due: December 8 at 11:59 PM on Canvas.**

You will submit two items: a report and an infographic.

### Report

Write a report of between 5 and 10 pages, not including appendices. Submit it as a PDF or Word document. The report should have five sections:
...
Document what you built with screenshots and a brief explanation of how it works. This appendix does not count toward the page limit.
...
- **Be specific.** "This tool is biased" is too vague. "When we tested the credit-scoring tool with identical applications but different names, it gave the one with a typically white-sounding name a 15\% higher score" is much better.
...
- **Divide the work early.** With 4-5 people and about six weeks, you have plenty of time if you start early. You do not have plenty of time if everyone waits until the last week.
